$.extend({
	...
	toast: function (obj) {
		...
		if (flag) {
			...
			var content = "<div id='toast-div' style='position: fixed; display: none;z-index:999; font-size: 14px; font-weight: 500; top: 0; left: 0;width:100%; height:100%; text-align: center'>";
		}
		content += '<div id="toast-content" style="display: inline-block; width: ' + width + ';min-height: ' + height + ';padding: 8px;background-color: ' + backgroundColor + ';text-align: center;font-size: 14px; font-weight: 500;line-height: ' + lineheight + ';border-radius: 4px;color: ' + textColor + ';">' + title + '</div>';
		content += '</div>';
		$("body").append(content);
